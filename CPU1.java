...
// クラス名を CPU1 に変更
public class CPU1 extends JFrame{
	...
	// コンストラクタ名を CPU1 に変更
	public CPU1(OthelloSample1 game, PlayerSample1 player) { //OthelloオブジェクトとPlayerオブジェクトを引数とする
	...
	private void choicePos(){
        ...
        // --- ランダムに選ぶ処理 ---
        // リストをシャッフルして、その先頭（0番目）を選択する
        java.util.Collections.shuffle(canmove);
        int pos_best = canmove.get(0);
        // -----------------------
	...
	public static void main(String args[]){
		...
		CPU1 oclient = new CPU1(game, player); //引数としてオセロオブジェクトを渡す
		//CPUは見えなくてもいい
